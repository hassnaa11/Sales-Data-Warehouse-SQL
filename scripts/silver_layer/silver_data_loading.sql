...
----- Load Data Into Silver Layer After Some Transformations & Cleaning ----- 
...
BEGIN
	BEGIN TRY
		...
		PRINT '-- Time Token: ' + CAST(DATEDIFF(second, @batch_start_time, @batch_end_time) AS VARCHAR(10)) + 'seconds';
	END TRY
	BEGIN CATCH
		PRINT '====================================';
